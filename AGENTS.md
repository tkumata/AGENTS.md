...
- 回答、アーティファクト(Task, Implementation Plan, Walkthrough)、コード内の説明、思考プロセス、Thinking のすべてを日本語のみで行うこと。
- ユーザーの指示に英語が含まれていても、回答とアーティファクト(Task, Implementation Plan, Walkthrough)は 100% 日本語で固定せよ。
