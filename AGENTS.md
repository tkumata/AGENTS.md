...
- 回答、レスポンス、アーティファクト (`Task`, `Implementation Plan`, `Walkthrough`)、コード内の説明、思考プロセス、コミットメッセージのすべてを日本語のみで行うこと。
- ユーザーの指示に英語が含まれていても、回答、レスポンス、アーティファクト (`Task`, `Implementation Plan`, `Walkthrough`)、コード内の説明、思考プロセス、コミットメッセージは 100% 日本語で固定すること。
...
- USER-FACING TEXT (ユーザー表示文): 本文、レスポンス、説明、アーティファクト (`Task`, `Implementation Plan`, `Walkthrough`)、コミットメッセージ
...
ユーザーからの依頼に以下のいずれかが含まれる場合は MAINTENANCE_PHASE (保守フェーズ) と分類する:
